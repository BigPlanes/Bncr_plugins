/**作者
 * @author 薛定谔的大灰机, DusKing
 * @name RouterOS
 * @origin 大灰机
 * @version 1.0.0
 * @description RouterOS重拨
...
// SSH参数
const host = '10.0.0.1' // 路由器IP
const port = 22         // SSH端口
const username = ''     // SSH用户名
const password = ''     // SSH密码
const command = '/interface disable pppoe-out1;/interface enable pppoe-out1'    // 执行命令
